...
module.exports.validateCreateProduct = [
  body("name").notEmpty().withMessage("Product name is required").isLength({ max: 100 }),
...
module.exports.unarchiveProduct = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Product unarchived successfully.", product: unarchivedProduct });
  } catch (err) {
